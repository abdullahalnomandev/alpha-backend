...
const create = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    ...
    message: 'Photo of interest created successfully',
    data: result,
  });
});
...
const update = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    success: true,
    statusCode: StatusCodes.OK,
    message: 'Photo of interest updated successfully',
    data: result,
  });
});
...
const remove = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    success: true,
    statusCode: StatusCodes.OK,
    message: 'Photo of interest deleted successfully',
    data: result,
  });
});
...
const getAll = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    success: true,
    statusCode: StatusCodes.OK,
    message: 'Photos of interest retrieved successfully',
...
const getById = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, {
    success: true,
    statusCode: StatusCodes.OK,
    message: 'Photo of interest retrieved successfully',
    data: result,
  });
});
